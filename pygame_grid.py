...
def drawgrid(screen,WINDOW_WIDTH,WINDOW_HEIGHT,table):
    BLACK = (0, 0, 0)
    RED = (255, 0, 0)
    WHITE = (200, 200, 200)
    blocksize = 30
...
def interface(nbcoln,nbline,tabal):
    ...
    while running:
        pygame.init()
        drawgrid(screen,WINDOW_WIDTH,WINDOW_HEIGHT,tabal)
        pygame.display.flip()
